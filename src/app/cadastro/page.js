                ...
                <div className="w-full h-full flex flex-row">
                    <div className="w-xl h-160  flex flex-col justify-center items-center">
                        ...
                        <div className=" bg-[#fcfcfe] w-100 h-100 rounded-2xl border p-10 ">
                            ...
                            <Button variant="outline" className={"p-1 w-30 h-15 font-extrabold bg-[#3FA0FF] text-[#fcfcfe] ml-25 houver:bg-[##2C2C2C]"}>Cadastre-se</Button>
                        </div>
                    </div>
                    <div>
                        <Image
